...
State::State() {
    ...
    auto goBG = new GameObject();
    goBG->box.x = 0;
    goBG->box.y = 0;

    auto bg = new Sprite(*goBG, "img/ocean.jpg");
    goBG->AddComponent(bg);
    ...
    auto ts = new TileSet(64, 64, "img/tileset.png");
	auto tm = new TileMap(*goMap, "map/tileMap.txt", ts);
    goBG->AddComponent(tm);
